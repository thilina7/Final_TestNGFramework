...
## General info
This project contains the framework written using java OOP concepts to automate word search feature of Roast Market.
...
1. In Eclipse, select File > Import… (Framework)
2. In the import window, expand Maven, select Existing Maven Projects, and click Next
3. Click Browse, and select the directory that contains the pom.xml file of the project.
...
#### Step 3: Install TestNG to the eclipse
...
#### Step 4: Run the Roast Market Assesment
1. Double click on the TestNG.xml file on the left "Framework" project tree
